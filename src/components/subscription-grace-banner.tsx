...
export function SubscriptionGraceBanner({
  ...
  return (
    <>
      <div
        className={`px-4 py-2.5 text-xs border-b flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 transition-colors print:hidden print-hide ${
          isUrgent
